...
export default function LeftSidebar() {
  ...
  return (
    ...
    {/* <div className={`sticky top-0 z-10 ${isSidebarOpen ? 'block' : 'hidden'} 2xl:block`}> */}
      <div className=" bg-white  rounded-md shadow-md  sticky top-[12vh]">
      ...
      <div className="mt-[10px] w-[500px] h-[447px] bg-white p-4 rounded-lg shadow-lg sticky top-[52vh] 2xl:w-[35vh] 2xl:h-auto">
        <NavBarDown />
      </div>
      </div>
    {/* </div> */}
