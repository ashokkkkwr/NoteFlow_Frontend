    ...
    >
      <div className='flex flex-col items-center'>
        {(user?.details?.profileImage?.length ?? 0) > 0 ? (
          ...
          <div  className='flex justify-center mt-1 2xl:mt-32'>
        ...
        <div className='ml mt-2'>
          <div className='ml-' key={user?.id}>
            <div className='flex mt-10'>
              <p className='text-4xl bold font-bold'>{user?.details.first_name}</p>
              <p className='ml-1 text-4xl bold font-bold'>{user?.details.last_name}</p>
            </div>
