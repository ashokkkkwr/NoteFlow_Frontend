...
const AddPost: React.FC<AddPostProps> = ({ onPostAdded }) => {
  ...
  return (
    <>
      <div className='mr-2 bg-white p-6 rounded-lg inline-flex flex-col min-w-max w-[492px] 2xl:w-[45vh] items-center justify-center shadow-md'>
        ...
        <form onSubmit={handleSubmit} encType='multipart/form-data' className='w-full'>
          ...
          <div {...getRootProps()} className={`mt-2 p-4 border-2 ${isDragActive ? 'border-red-400' : 'border-gray-300'} border-dashed rounded-lg cursor-pointer flex flex-col items-center justify-center`}>
            <input {...getInputProps()} />
            {isDragActive ? (
